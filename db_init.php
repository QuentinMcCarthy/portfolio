<?php
	...
	if($_POST){
		...
		if(empty($errors)){
			...
			$sql .= "CREATE TABLE `projects` (`id` tinyint(6) UNSIGNED NOT NULL, `name` varchar(100) CHARACTER SET utf8mb4 NOT NULL, `url` varchar(25) CHARACTER SET utf8mb4 NOT NULL, `image` varchar(100) CHARACTER SET utf8mb4 NOT NULL, `description` varchar(1000) CHARACTER SET utf8mb4 NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1; ";
			$sql .= "ALTER TABLE `projects` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `url` (`url`), ADD UNIQUE KEY `image` (`image`); ";
